...
import (
	...
	"github.com/delta-chain/delta/v2/x/e2ee/keyring"
	"github.com/delta-chain/delta/v2/x/e2ee/types"
)
...
func DecryptCommand() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			kr, err := keyring.New("deltad", clientCtx.Keyring.Backend(), clientCtx.HomeDir, os.Stdin)
			if err != nil {
				return err
			}
