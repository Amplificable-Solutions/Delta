...
func GetQueryCmd(queryRoute string) *cobra.Command {
	// Group delta queries under a subcommand
	cmd := &cobra.Command{
...
func QueryParamsCmd() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "params",
		Short: "Query the current delta parameters",
		Args:  cobra.NoArgs,
		Long: strings.TrimSpace(`Query the current delta parameters:

$ <appd> query delta params
`),
