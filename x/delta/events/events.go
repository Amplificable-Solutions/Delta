...
import (
	...
	ica "github.com/delta-chain/delta/v2/x/delta/events/bindings/cosmos/precompile/ica"
	relayer "github.com/delta-chain/delta/v2/x/delta/events/bindings/cosmos/precompile/relayer"
	deltaeventstypes "github.com/delta-chain/delta/v2/x/delta/events/types"
...
var (
	...
	RelayerValueDecoders = ValueDecoders{
		...
		deltaeventstypes.AttributeKeySrcPortInfo:    ReturnStringAsIs,
		channeltypes.AttributeKeySrcChannel:         ReturnStringAsIs,
		deltaeventstypes.AttributeKeySrcChannelInfo: ReturnStringAsIs,
	...
	IcaValueDecoders = ValueDecoders{
		deltaeventstypes.AttributeKeySeq:    ConvertUint64,
		channeltypes.AttributeKeySrcChannel: ReturnStringAsIs,
	}
)
...
func RelayerConvertEvent(event sdk.Event) (*ethtypes.Log, error) {
	...
	replaceAttrs := map[string]string{
		deltaeventstypes.AttributeKeySrcPortInfo:    channeltypes.AttributeKeySrcPort,
		deltaeventstypes.AttributeKeySrcChannelInfo: channeltypes.AttributeKeySrcChannel,
	}
