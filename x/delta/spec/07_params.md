...
The Delta module contains the following parameters:
...
- `IbcTimeout` The timeout value to use when Delta module transfer tokens to IBC channels.

  Can be updated at runtime.

- `DeltaAdmin` The account that is authorized to manage token mapping through message, empty means no admin, should be a valid bech32 cosmos address if specified.
