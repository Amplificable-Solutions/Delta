...
// GetAuthority returns the x/delta module's authority.
...
func (k Keeper) onPacketResult(
	...
	data, err := deltaprecompiles.OnPacketResultCallback(packet.SourceChannel, packet.Sequence, acknowledgement)
	if err != nil {
		return err
	}
