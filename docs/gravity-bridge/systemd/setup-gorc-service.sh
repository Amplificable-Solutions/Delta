...
download_service() {
    curl -s https://raw.githubusercontent.com/crypto-org-chain/delta/main/docs/gravity-bridge/systemd/gorc.service.template -o $BASEDIR/gorc.service.template
}
...
gather_orchestrator_info() {
    ...
    read -p 'Please input orchestrator delta key name: ' croKey
    echo "delta key: $croKey eth key: $ethKey"
