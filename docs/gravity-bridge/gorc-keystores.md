...
grpc = "http://localhost:9090" # TODO - GRPC of Delta node
key_derivation_path = "m/44'/60'/0'/0/0"
...
- `$keys-prefix`: prefix for the keys created (e.g. delta-testnet3-orch*). Then you'd be able to create keys `delta-testnet3-orch1` and `delta-testnet3-orch2`
