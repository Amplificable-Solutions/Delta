...
In the effort to not change the CRC20 standard, we have defined a new CRC21 standard that specify two events (`__DeltaSendToChain` and `__DeltaCancelSendToChain`) allowing cross-chain transfer of CRC20 through the gravity bridge. (https://github.com/delta-chain/delta/blob/main/contracts/src/ModuleCRC21.sol)
...
* https://github.com/delta-chain/delta/issues/547
* https://github.com/delta-chain/delta/pull/544
* https://github.com/delta-chain/delta/blob/main/contracts/src/ModuleCRC21.sol