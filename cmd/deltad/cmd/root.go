...
import (
	...
	memiavlcfg "github.com/delta-chain/delta/store/config"
	...
	e2eecli "github.com/delta-chain/delta/v2/x/e2ee/client/cli"
	// this line is used by starport scaffolding # stargate/root/import
)

const EnvPrefix = "DELTA"
...
func addModuleInitFlags(startCmd *cobra.Command) {
	...
	delta.AddModuleInitFlags(startCmd)
...
func appExport(
	...
	var deltaApp *app.App
	if height != -1 {
		deltaApp = app.New(logger, db, traceStore, false, appOpts)

		if err := deltaApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		deltaApp = app.New(logger, db, traceStore, true, appOpts)
	}

	return deltaApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs, modulesToExport)
}
