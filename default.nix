...
let
  ...
  ldflags = lib.concatStringsSep "\n" ([
    "-X github.com/cosmos/cosmos-sdk/version.Name=delta"
...
buildGoApplication rec {
  ...
  postFixup = lib.optionalString (stdenv.isDarwin && rocksdb != null) ''
    ${stdenv.cc.bintools.targetPrefix}install_name_tool -change "@rpath/librocksdb.8.dylib" "${rocksdb}/lib/librocksdb.dylib" $out/bin/deltad
  '';

  doCheck = false;
  meta = with lib; {
    description = "Official implementation of the Delta blockchain protocol";
    homepage = "https://delta.org/";
    license = licenses.asl20;
    mainProgram = "deltad" + stdenv.hostPlatform.extensions.executable;
