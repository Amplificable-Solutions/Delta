...
def custom_delta_eq(tmp_path_factory):
...
@pytest.fixture(scope="module")
def custom_delta_lte(tmp_path_factory):
...
@pytest.fixture(
    scope="module",
    params=["custom_delta_eq", "custom_delta", "custom_delta_lte"],
)
def custom_cluster(request, custom_delta_eq, custom_delta_lte, custom_delta):
    if request.param == "custom_delta_eq":
        return custom_delta_eq
    elif request.param == "custom_delta_lte":
        return custom_delta_lte
    return custom_delta
