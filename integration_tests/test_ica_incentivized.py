...
def test_incentivized(ibc):
    ...
    cli_controller = ibc.delta.cosmos_cli()
    ...
    ibc.delta.supervisorctl("stop", "relayer-demo")
    time.sleep(3)
    port_id = "icahost"
    ...
    ibc.delta.supervisorctl("start", "relayer-demo")
    ...
    actual = get_balance(ibc.delta, sender, fee_denom)
