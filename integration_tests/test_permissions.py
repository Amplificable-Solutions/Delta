...
def test_permissions_updates(delta):
    """
    ...
    cli = delta.cosmos_cli(2)  # node2 is iavl
    ...
    delta.supervisorctl("stop", "delta_777-1-node2")
    print(cli.prune())
    delta.supervisorctl("start", "delta_777-1-node2")
