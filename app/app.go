...
import (
	...
	memiavlstore "github.com/delta-chain/delta/store"
	"github.com/delta-chain/delta/v2/client/docs"
	delta "github.com/delta-chain/delta/v2/x/delta"
	deltaclient "github.com/delta-chain/delta/v2/x/delta/client"
	deltakeeper "github.com/delta-chain/delta/v2/x/delta/keeper"
	evmhandlers "github.com/delta-chain/delta/v2/x/delta/keeper/evmhandlers"
	deltaprecompiles "github.com/delta-chain/delta/v2/x/delta/keeper/precompiles"
	"github.com/delta-chain/delta/v2/x/delta/middleware"
	deltatypes "github.com/delta-chain/delta/v2/x/delta/types"
	e2eekeyring "github.com/delta-chain/delta/v2/x/e2ee/keyring"

	e2ee "github.com/delta-chain/delta/v2/x/e2ee"
	e2eekeeper "github.com/delta-chain/delta/v2/x/e2ee/keeper"
	e2eetypes "github.com/delta-chain/delta/v2/x/e2ee/types"
	"github.com/ethereum/go-ethereum/common"

	// force register the extension json-rpc.
	_ "github.com/delta-chain/delta/v2/x/delta/rpc"
...
var (
	...
	maccPerms = map[string][]string{
		...
		deltatypes.ModuleName:          {authtypes.Minter, authtypes.Burner},
	}
	// Module configurator
...
func New(
	...
	var identity age.Identity
	{
		if cast.ToString(appOpts.Get("mode")) == "validator" {
			...
			kr, err := e2eekeyring.New("deltad", krBackend, homePath, os.Stdin)
			if err != nil {
				panic(err)
			}
	...
	app.EvmKeeper = evmkeeper.NewKeeper(
		...
		[]evmkeeper.CustomContractFn{
			func(_ sdk.Context, rules ethparams.Rules) vm.PrecompiledContract {
				return deltaprecompiles.NewRelayerContract(app.IBCKeeper, app.IBCFeeKeeper, appCodec, rules, app.Logger())
			},
			func(ctx sdk.Context, rules ethparams.Rules) vm.PrecompiledContract {
				return deltaprecompiles.NewIcaContract(ctx, app.ICAControllerKeeper, &app.DeltaKeeper, appCodec, gasConfig)
			},
		},
	)
	...
	app.DeltaKeeper = *deltakeeper.NewKeeper(
		appCodec,
		keys[deltatypes.StoreKey],
		keys[deltatypes.MemStoreKey],
		app.BankKeeper,
		app.TransferKeeper,
		app.EvmKeeper,
		app.AccountKeeper,
	...
	deltaModule := delta.NewAppModule(app.DeltaKeeper, app.AccountKeeper, app.BankKeeper, app.GetSubspace(deltatypes.ModuleName))

	// register the proposal types
	govRouter := govv1beta1.NewRouter()
	govRouter.AddRoute(govtypes.RouterKey, govv1beta1.ProposalHandler).
		AddRoute(paramproposal.RouterKey, params.NewParamChangeProposalHandler(app.ParamsKeeper)).
		AddRoute(deltatypes.RouterKey, delta.NewTokenMappingChangeProposalHandler(app.DeltaKeeper))
	...
	*/
	...
	transferStack = middleware.NewIBCConversionModule(transferStack, app.DeltaKeeper)
	...
	app.EvmKeeper.SetHooks(deltakeeper.NewLogProcessEvmHook(
		evmhandlers.NewSendToAccountHandler(app.BankKeeper, app.DeltaKeeper),
		evmhandlers.NewSendToIbcHandler(app.BankKeeper, app.DeltaKeeper),
		evmhandlers.NewSendCroToIbcHandler(app.BankKeeper, app.DeltaKeeper),
		evmhandlers.NewSendToIbcV2Handler(app.BankKeeper, app.DeltaKeeper),
	))
	...
	// we don't limit gas usage here, because the delta keeper will use network parameter to control it.
	icaControllerStack = ibccallbacks.NewIBCMiddleware(icaControllerStack, app.IBCFeeKeeper, app.DeltaKeeper, math.MaxUint64)
...
func (app *App) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64, blacklist []string) error {
	...
	blockAddressDecorator := NewBlockAddressesDecorator(blockedMap, app.DeltaKeeper.GetParams)
...
func (app *App) RefreshBlockList(ctx sdk.Context) error {
	// refresh blocklist
	return app.blockProposalHandler.SetBlockList(app.DeltaKeeper.GetBlockList(ctx))
}
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(deltatypes.ModuleName).WithKeyTable(deltatypes.ParamKeyTable())
